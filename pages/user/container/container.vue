<template>
  <view>
    ...
    <view class="page-header">
      <text class="header-title">我的发布书籍</text>
    </view>
    ...
    <view class="purchase-list">
      <view v-for="(request, index) in purchaseRequests" :key="index" class="purchase-item">
        ...
        <view class="item-info">
          ...
          <text class="item-price">发布价格：¥{{ request.expectedPrice }}</text>
        </view>
...
export default {
  data() {
    return {
      purchaseRequests: [
        { id: 1, bookName: 'Sql用于数据分析', expectedPrice: 45, imageUrl: 'https://mp-06cb9cdc-8c7c-46a3-9e40-23b4c64fd8a3.cdn.bspapp.com/book/06.jpg' },
        { id: 2, bookName: '漫长的等待', expectedPrice: 32, imageUrl: 'https://mp-06cb9cdc-8c7c-46a3-9e40-23b4c64fd8a3.cdn.bspapp.com/book/08.jpg' },
      ],
    };
  },
  methods: {
